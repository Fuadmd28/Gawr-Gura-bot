...
let teksbio = `┆⫹⫺ 💌 Nama : Bang Fuad
┆⫹⫺ ✉️ Nama RL : HAMBA ALLAH
┆⫹⫺ ♂️ Gender : Pria
┆⫹⫺ 🕋 Agama : Islam
┆⫹⫺ ⏰ Tanggal lahir : 16 - 10 - 1999
┆⫹⫺ 🎨 Umur : 21
┆⫹⫺ 🧮 Kelas : Di nasa
┆⫹⫺ 🧩 Hobby : 𝙼𝚘𝚍𝚒𝚏𝚒𝚔𝚊𝚜𝚒 𝚙𝚎𝚛𝚊𝚗𝚐𝚔𝚊𝚝 𝚕𝚞𝚗𝚊𝚔
┆⫹⫺ 💬 Nomor wa : wa.me/628989513496
...
let teksbio2 = `┆⫹⫺ 💌 Nama : Kang Satir
┆⫹⫺ ✉️ Nama RL : HAMBA ALLAH
┆⫹⫺ ♂️ Gender : Wanita
┆⫹⫺ 🕋 Agama : Islam
┆⫹⫺ ⏰ Tanggal lahir : 07 - 05 - 1990
┆⫹⫺ 🎨 Umur : 57
┆⫹⫺ 🧮 Kelas : Pensi
┆⫹⫺ 🧩 Hobby : Banyak
┆⫹⫺ 💬 Nomor wa : wa.me/628989513496
...
title: `⫹⫺ Oᴛʜᴇʀ ⫹⫺`,
rows: [
{title: "⸙ Biodata Bang Fuad", rowId: ".owner bio"},
{title: "⸙ Biodata Kang Satir", rowId: ".owner bio2"},
]}, {
title: `⬔ Sᴜᴘᴘᴏʀᴛ Mᴇ ⬔`,
rows: [
...
await conn.sendMessage(m.chat, { contacts: { displayName: wm, contacts: [{ vcard }] }}, { quoted: ftroli })
 ...
 conn.send2ButtonImg(m.chat, fs.readFileSync('./media/own.jpg').buffer, teksnomor, `Halo ${tag}\nIᴛᴜ Oᴡɴᴇʀ Kᴜ⫺⫰⫹\n` + botdate, `Sewa Bot`, `.sewa`, 'Menu', `.menu`, ftroli, { contextInfo: { externalAdReply: { showAdAttribution: true,
   ...
   conn.sendButton(m.chat, '┍┈༺ *𝙱𝚒𝚘𝙳𝚊𝚝𝚊 Bang Fuad* ༻', teksbio, ppown, [
                ['Sewa Bot', `${usedPrefix}sewa`],
                ['Menu', `${usedPrefix}menu`]
            ], m)
            break
          ...
          conn.sendButton(m.chat, '┍┈༺ *𝙱𝚒𝚘𝙳𝚊𝚝𝚊 Kang Satir* ༻', teksbio2, ppown2, [
                ['Sewa Bot', `${usedPrefix}sewa`],
                ['Menu', `${usedPrefix}menu`]
            ], m)
            break
